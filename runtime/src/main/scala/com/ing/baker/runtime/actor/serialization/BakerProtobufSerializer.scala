...
class BakerProtobufSerializer(system: ExtendedActorSystem) extends SerializerWithStringManifest {
  ...
  val manifestInfo = Seq(
    ...
    Entry("ProcessIndexProtocol.ProcessEvent", classOf[ProcessIndexProtocol.FireEvent], actor.process_index.protobuf.ProcessEvent),
    ...
    Entry("ProcessIndexProtocol.ProcessEventResponse", classOf[ProcessIndexProtocol.FireEventResponse], actor.process_index.protobuf.ProcessEventResponse),
