...
object Event {
  ...
  /**
    ...
    * @return
    */
  def retryExhaustedEventName(interactionClass: Class[_]): String = interactionClass.getSimpleName + javadsl.exhaustedEventAppend
  ...
  /**
    ...
    * @return
    */
  def retryExhaustedEventName(interactionName: String): String = interactionName + javadsl.exhaustedEventAppend
}
